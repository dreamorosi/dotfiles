---
name: commit
description: Create commit messages following global conventions. Use when committing code changes, writing commit messages, or formatting git history. Follows conventional commits with project-specific issue references if any.
---

# Commit Messages

Follow these conventions when creating commits for all projects.
...
When changes were primarily generated by a coding agent (like Claude Code or Opencode), include the Co-Authored-By attribution in the commit footer:
